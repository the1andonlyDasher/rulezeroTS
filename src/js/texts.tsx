...
export const texts: any = {
    ...
    Fitch: (<><p>I’m Jon Fitch. I’m a coach, writer, and retired MMA world champ living in San Jose, California. I was born in the All-American city of Ft. Wayne, Indiana.  Super competitive from the start, I began wrestling and playing football at just 9 years old. My love of wrestling never went away and I found myself walking on to the wrestling team at Purdue University. Uninfluenced by people advising me down a “safe” path, I pursued a professional fighting career in 2002, which lasted 18 lengthy years.  And I ain’t even tired yet. Since retiring from MMA, I have focused on raising my two amazing boys, Mason and Atlas. I’ve also repurposed my fighter mindset into the workings of a serial entrepreneur through starting Fitch SMASH LLC and my one-on-one consulting and coaching services. I aspire to motivate men to reach their pinnacle, both physically and mentally. I work hard to create a community of purpose-driven men through my weekly podcast, Jon Fitch Knows Nothing and my men’s group, SMASHSociety. </p>
    <motion.div variants={parent} className="socials">
